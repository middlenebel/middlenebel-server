...
string K8SNamespace::apply(){
     ...
     LOG("K8SNamespace::apply");
     string result = "";
     string command = "kubectl create namespace "+attributes[ATT_NAME];
     result = systemCommandList(command, attributes[ATT_APP],getAtt(ATT_NAMESPACE),"?","kubectl create namespace "+attributes[ATT_NAME]);
     return result;
}
string K8SNamespace::destroy(){
     ...
     try{
          ...
          result = "ERROR K8SNamespace.doDestroy ";
     }
     return result;
}
